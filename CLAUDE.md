...
This file is project memory for Claude Code. A mirror `AGENTS.md` exists for Copilot CLI and **must be kept byte-equivalent in semantic content** — fairness of the comparison depends on it. When you edit one, edit the other.
